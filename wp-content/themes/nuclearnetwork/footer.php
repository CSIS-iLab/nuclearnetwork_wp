	...
	<footer id="colophon" class="site-footer">
		<div class="site-info content-wrapper row">
			<div class="footer-info col-xs-12 col-md-6">
				...
				?>
			<div class="footer-info related">
				<h5 class="footer-info section-title">Visit Our Other Projects —</h5>
					<div class="footer-info logo-wrapper col-xs-12 col-md-6">
						<a href="https://ontheradar.csis.org" target="_blank">
							<img src="/wp-content/themes/nuclearnetwork/img/on-the-radar-logo.svg" alt ="On the Radar Logo" title="On the Radar Logo">
					</div>
			</div>
			</div>
