...
if (! function_exists('nuclearnetwork_authors_list_extended')) :
	...
	function nuclearnetwork_authors_list_extended()
	{
		...
		if (function_exists('coauthors_posts_links')) {
			$authors = '<h2 class="section__heading post__authors-heading">Authors</h2><p class="text--italic text--long post__authors-disclaimer">The views expressed above are the author’s and do not necessarily reflect those of the Center for Strategic and International Studies or the Project on Nuclear Issues.</p>';
